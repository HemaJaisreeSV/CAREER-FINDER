                ...
                <div class="menu">
                    <ul>
                        ...
                        <li> <a href="#">Login</a>
                         ...
                         <li> 
                             <a href="print_about_us.php" >About Us </a> </li> 
                        <li> <a href="print_contact_us.php" >Contact Us </a>  </li> 
                        
                    </ul>
                </div>
            </div>
            <p style="color:white;text-align:center;font-family:comic-sans-serif;"  >
                <b>
                        " IT'S NOT WHAT YOU ACHIEVE, IT'S WHAT YOU OVERCOME. 
                            THAT'S WHAT DEFINES YOUR CAREER "</b></p>
